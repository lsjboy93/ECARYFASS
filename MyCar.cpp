...
ControlValues control_driving(CarStateValues sensing_info)
{
	...
	//float set_steering = (avr_angle - sensing_info.moving_angle) / (180 - sensing_info.speed);
	...
	//			avr_angle = (float)(abs(atan((diff - avoid_width) / fwd_obstacle.dist) * 57.29579));
	//			middle_add = 0;
	//			if (diff > 0) avr_angle += -1;
	//		}
	//	}
	//}
	//
